...
namespace ReferenceClientes
{
    ...
    public interface IClientesContract
    {
        ...
        System.Threading.Tasks.Task<ReferenceClientes.Cliente> FindClienteAsync(int idcliente);
    }
    ...
    public partial class ClientesContractClient : System.ServiceModel.ClientBase<ReferenceClientes.IClientesContract>, ReferenceClientes.IClientesContract
    {
        ...
        public System.Threading.Tasks.Task<ReferenceClientes.Cliente> FindClienteAsync(int idcliente)
        {
            return base.Channel.FindClienteAsync(idcliente);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IClientesContract))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:51180/ServicioWCFClientes.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
